...
def main_video(input_video_path=None):
    check_requirements(exclude=('tensorboard', 'thop'))
    video_path, txt_path = run(source=input_video_path)
    return video_path, txt_path


# if __name__ == "__main__":
#     video_path = '../static/videos/video_2021120914292678.mp4'
#
#     a, b = main_video(video_path)
#
#     print(a, b)